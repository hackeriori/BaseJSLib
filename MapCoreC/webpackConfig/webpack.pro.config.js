...
module.exports = {
  ...
  output: {
    ...
    filename: "mapCoreC.js",
    chunkFilename: "mapCoreC.[name].js",
  },
  module: {
    rules: [
  ...
  plugins: [
    new CleanWebpackPlugin({
      cleanOnceBeforeBuildPatterns: ['**/*', '!Cesium/**', '!Cesium'],
      cleanAfterEveryBuildPatterns: ['outLib', 'mapCoreC.js.LICENSE.txt']
    }),
    new MiniCssExtractPlugin({
      filename: 'mapCoreC.css'
    }),
